...
def test_code(test_case):
    ...
    T_corr = simplify(rz*ry)
    T0_G = T0_1 * T1_2 * T2_3 * T3_4 * T4_5 * T5_6 * T6_G
    T_t = T0_G * T_corr
    
    ee = T_t.evalf(subs={q1: theta1, q2: theta2, q3: theta3, q4: theta4, q5: theta5, q6: theta6})
    ee_x = ee[0,3]
    ee_y = ee[1,3]
    ee_z = ee[2,3]
    ...
    your_ee = [ee_x,ee_y,ee_z] # <--- Load your calculated end effector value from your forward kinematics
    ########################################################################################
